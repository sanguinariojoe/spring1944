...
local options = {
    ...
    {
        key = '3garrison',
        name = 'Garrison settings',
        desc = 'Position of the Garrison',
        type = 'section',
    },
    {
        key = "garrison",
        name = "Spawn a Garrison",
        desc = "A Garrison is a building which can be captured",
        type = "list",
        section = '3garrison',
        def = "no",
        items = {
            { key = "yes", name = "Yes", desc = "A Garrison is spawned"},
            { key = "no", name = "No", desc = "No Garrison is spawned"},
        },
    },
    {
        key = "garrisonx",
        name = "X coordinate",
        desc = "X coordinate (in percentage of the map width)",
        type = "number",
        def = 50,
        min = 5,
        max = 95,
    ...
    },
    {
        key = "garrisony",
        name = "Y coordinate",
        desc = "Y coordinate (in percentage of the map height)",
        type = "number",
        def = 50,
        min = 5,
        max = 95,
